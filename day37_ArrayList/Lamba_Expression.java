...
public class Lamba_Expression {
    ...
    public static void main(String[] args) {
        ...
        list.addAll(Arrays.asList(1,2,3,4,5,6,6,6,7,8,9));
        ...
        names.addAll(Arrays.asList("Mary","Monica","Mehray","Musit","Sumeyra","Hasan","Beril"));
        ...
        nums.removeIf( p-> Collections.frequency(nums,p) !=1 );
                     // foe the element that are not unique
