...
public class BulkOperations {
    ...
    public static void main(String[] args) {
        ...
        //add:30,25,40,15,......95,100
        /*
         Integer[] nums ={30,25,40,15,95,100};
        numbers.addAll(  Arrays.asList(nums)  );
         */

        numbers.addAll(  Arrays.asList(  30,25,40,15,95,100)  );
        System.out.println(numbers);

        System.out.println("=========================================");

        ArrayList<Integer> nums = new ArrayList<>();
        nums.addAll(Arrays.asList(1,1,10,2,33,4,5,6,7,8,99,0));
        System.out.println(nums);
        // remove all 1,2,4,10,0

        nums.removeAll( Arrays.asList(1,2,4,10,0) );
        System.out.println(nums);

        System.out.println("===========================");
        ArrayList<Integer> num1 = new ArrayList<>();
        num1.addAll(  Arrays.asList(1,1,2,2,3,4,5,6,7,7,7,8,8,8,9)  );
