...
public class GradeReport {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Integer> list = new ArrayList<>();// list is collection type
        list.addAll(Arrays.asList( 100,90,85,75,55,45,73,73,35,47,60,87,77,67,57,93,83,73,63,53,43 ));
